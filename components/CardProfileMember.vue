    ...
    <div class="card" @click.stop="">
        <div class="card-header py-1 px-2 bg-primary text-white profile-head">
            ...
            <div class="d-flex mt-2">
                <div>
                    <img :src="this.data.profile_pic" class="profile-pic rounded-circle"/>
                </div>

                <div class="profile-info">
                    <h5 class="mb-0 ml-2 mt-2 profile-fullname">{{ this.data.full_name }}</h5>
                    <h6 class="ml-2 kanban-text profile-email">{{ this.data.email }}</h6>
                </div>
            </div>
        </div>
